...
export class UpdateMissionComponent implements OnInit {
  ...
  constructor(public fb: FormBuilder, public service: AdminsideServiceService, public toastr: ToastrService, public router: Router, public activateRoute: ActivatedRoute, public datePipe: DatePipe, private toast: NgToastService)
  {
  ...
  //   let updateImageUrl = '';
  //   var SkillLists = Array.isArray(value.missionSkillId) ? value.missionSkillId.join(",") : value.missionSkillId;
